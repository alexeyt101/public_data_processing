...
def density(t: ParamTypes) -> ParamTypes:
    '''Функция возвращает плотность керосина при температуре t [C]'''
    return -0.72000 * t + 794


def kinematic_visc(t: ParamTypes) -> ParamTypes:
...
def dynamic_visc(t: ParamTypes) -> ParamTypes:
...
def vap_press(t: ParamTypes) -> ParamTypes:
